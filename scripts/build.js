...
<header class="site-header">
  <div class="container header-row">
    ...
    <nav class="nav">
      <a href="/_gen/">Home</a>
      <a href="/_gen/category/divorce-kits/">Uncontested Divorce Forms</a>
    </nav>
  </div>
</header>
...
<section class="section hero">
  <div class="container hero-grid">
    <div>
      ...
      <div class="hero-cta">
        <a class="btn btn--primary" href="/_gen/category/divorce-kits/">Browse Uncontested Divorce Forms</a>
      </div>
    </div>
  </div>
</section>`
...
function buildCategory(){
  write(
    ...
    page({
      title: "Uncontested Divorce Forms by State | Uncontested Divorce Forms",
      desc: "Uncontested divorce forms for all 50 states. With or without children. Flat pricing.",
      body: `
<section class="section">
  <div class="container">
    <h1>Uncontested Divorce Forms by State</h1>
...
function buildState(state){
  write(
    ...
    page({
      title: `${state.name} Uncontested Divorce Forms | Uncontested Divorce Forms`,
      desc: `Uncontested divorce forms for ${state.name}. Court-approved. Flat pricing. Fee waiver included.`,
      body: `
<section class="section">
  <div class="container">
    <h1>${state.name} Uncontested Divorce Forms</h1>
